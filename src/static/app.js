document.addEventListener("DOMContentLoaded", () => {
              ...
              .map(
                (participant) =>
                  `<li>
                    ...
                    <button class="delete-btn" data-activity="${escapeHtml(name)}" data-email="${escapeHtml(participant)}" title="Unregister">🗑️</button>
                  </li>`
              )
              .join("")}</ul>`
  ...
  // Handle unregistering from an activity
